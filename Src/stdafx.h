...
#define		UM_THRED_BEGIN				WM_USER + 3
#define		UM_THRED_END				WM_USER + 4

extern HWND g_hMainFrame;
extern BOOL g_bExitProcess;
...
typedef union _tagIPMask
{
	unsigned char Class[4]; // 0 = Aclass, 1 = Bclass, 2 = Cclass, 3 = Dclass
	unsigned long Ip;
} IPMask, *lpIPMask;
...
BOOL ParseStr(char *szSource,char *szDest,char nCode='.',int nNum=0);
